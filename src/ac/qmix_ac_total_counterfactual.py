...
class QMIX_PG():
    def __init__(self, agent, args):
        ...
        self.model_dir = args.model_dir + '/' + 'ac_total_counterfactual_sample' +  '/' + f'{args.actor_buffer_size}_'+f'{args.actor_update_delay}_'+f'{args.actor_train_steps}'+ '/' + args.alg + '/' + args.map  # TODO
        # 如果存在模型则加载模型
