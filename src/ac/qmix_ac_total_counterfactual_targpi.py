...
class QMIX_PG():
    def __init__(self, agent, args):
        ...
        self.model_dir = args.model_dir + '/' + 'ac_total_counterfactual_targpi' +  '/' + f'{args.actor_buffer_size}_'+f'{args.actor_update_delay}_'+f'{args.actor_train_steps}'+ '/' + args.alg + '/' + args.map  # TODO
        # 如果存在模型则加载模型
    ...
    def train_actor(self, batch, max_episode_len):  # EpisodeBatch
        ...
        q_mean_actions = torch.sum(target_actions_prob * q_vals, dim=-1).detach()  # (1,60,3)
        q_i_mean_negi_taken = []
